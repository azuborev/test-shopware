...
(require __DIR__.'/Shopware_Production_KernelProdContainer.php')->set(\ContainerJ4igkr7\Shopware_Production_KernelProdContainer::class, null);
...
$classes[] = 'Swag\PayPal\SwagPayPal';
$classes[] = 'SwagExtensionStore\SwagExtensionStore';
$classes[] = 'Zuborev\BasicPlugin\ZuborevBasicPlugin';
$classes[] = 'Sas\BlogModule\SasBlogModule';
$classes[] = 'SkeletonPlugin\SkeletonPlugin';
...
$classes[] = 'Sas\BlogModule\Content\BlogAuthor\BlogAuthorDefinition';
$classes[] = 'Sas\BlogModule\Content\BlogAuthor\BlogAuthorTranslation\BlogAuthorTranslationDefinition';
$classes[] = 'Sas\BlogModule\Content\BlogCategory\BlogCategoryDefinition';
$classes[] = 'Sas\BlogModule\Content\BlogCategory\BlogCategoryIndexer';
$classes[] = 'Sas\BlogModule\Content\BlogCategory\BlogCategoryTranslation\BlogCategoryTranslationDefinition';
$classes[] = 'Sas\BlogModule\Content\Blog\Aggregate\BlogCategoryMappingDefinition';
$classes[] = 'Sas\BlogModule\Content\Blog\BlogEntriesDefinition';
$classes[] = 'Sas\BlogModule\Content\Blog\BlogEntriesTranslation\BlogEntriesTranslationDefinition';
$classes[] = 'Sas\BlogModule\Content\Blog\BlogSeoUrlListener';
$classes[] = 'Sas\BlogModule\Content\Blog\BlogSeoUrlRoute';
$classes[] = 'Sas\BlogModule\Content\Blog\DataResolver\BlogCmsElementResolver';
$classes[] = 'Sas\BlogModule\Content\Blog\DataResolver\BlogSingleSelectDataResolver';
$classes[] = 'Sas\BlogModule\Content\Blog\Subscriber\BlogSubscriber';
$classes[] = 'Sas\BlogModule\Content\Extension\LanguageExtension';
$classes[] = 'Sas\BlogModule\Content\Extension\MediaExtension';
$classes[] = 'Sas\BlogModule\Content\Extension\SalutationExtension';
$classes[] = 'Sas\BlogModule\Content\SalesChannel\Suggest\ProductSuggestDecorated';
$classes[] = 'Shopware\Core\Content\Product\SalesChannel\Suggest\ProductSuggestRoute';
$classes[] = 'Sas\BlogModule\Controller\BlogController';
$classes[] = 'Sas\BlogModule\Page\Search\BlogSearchPageLoader';
$classes[] = 'Sas\BlogModule\Controller\StoreApi\BlogController';
$classes[] = 'Sas\BlogModule\Core\Content\Sitemap\Provider\BlogUrlProvider';
$classes[] = 'Sas\BlogModule\Resources\snippet\de_DE\SnippetFile_de_DE';
$classes[] = 'Sas\BlogModule\Resources\snippet\en_GB\SnippetFile_en_GB';
...
$classes[] = 'Shopware\Core\Framework\App\Payment\Handler\AppPreparedPaymentHandler';
...
$classes[] = 'Swag\PayPal\Storefront\Framework\Cookie\PayPalCookieProvider';
...
$classes[] = 'Swag\PayPal\Administration\PayPalPaymentMethodController';
$classes[] = 'Swag\PayPal\Checkout\Cart\Service\CartPriceService';
$classes[] = 'Swag\PayPal\Checkout\Cart\Validation\CartValidator';
$classes[] = 'Swag\PayPal\Checkout\CheckoutSubscriber';
$classes[] = 'Swag\PayPal\Checkout\ExpressCheckout\ExpressCheckoutSubscriber';
$classes[] = 'Swag\PayPal\Checkout\ExpressCheckout\SalesChannel\ExpressCategoryRoute';
$classes[] = 'Swag\PayPal\Checkout\ExpressCheckout\SalesChannel\ExpressCreateOrderRoute';
$classes[] = 'Swag\PayPal\Checkout\ExpressCheckout\SalesChannel\ExpressPrepareCheckoutRoute';
$classes[] = 'Swag\PayPal\Checkout\ExpressCheckout\Service\ExpressCustomerService';
$classes[] = 'Swag\PayPal\Checkout\ExpressCheckout\Service\PayPalExpressCheckoutDataService';
$classes[] = 'Swag\PayPal\Checkout\PUI\PUISubscriber';
$classes[] = 'Swag\PayPal\Checkout\PUI\Service\PUIFraudNetDataService';
$classes[] = 'Swag\PayPal\Checkout\PUI\Service\PUIPaymentInstructionDataService';
$classes[] = 'Swag\PayPal\Checkout\PUI\SalesChannel\PUIPaymentInstructionsRoute';
$classes[] = 'Swag\PayPal\Checkout\Payment\Handler\PlusPuiHandler';
$classes[] = 'Swag\PayPal\PaymentsApi\Patch\PayerInfoPatchBuilder';
$classes[] = 'Swag\PayPal\PaymentsApi\Patch\OrderNumberPatchBuilder';
$classes[] = 'Swag\PayPal\PaymentsApi\Patch\CustomTransactionPatchBuilder';
$classes[] = 'Swag\PayPal\PaymentsApi\Patch\ShippingAddressPatchBuilder';
$classes[] = 'Swag\PayPal\Checkout\Payment\Method\ACDCHandler';
$classes[] = 'Swag\PayPal\Checkout\Payment\Method\APMHandler';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\BancontactOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\BlikOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\EpsOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\GiropayOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\IdealOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\MultibancoOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\MyBankOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\OxxoOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\P24OrderBuilder';
$classes[] = 'Swag\PayPal\Checkout\Payment\Method\PUIHandler';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\PUIOrderBuilder';
$classes[] = 'Swag\PayPal\Checkout\PUI\Service\PUICustomerDataService';
$classes[] = 'Swag\PayPal\Checkout\Payment\Method\SEPAHandler';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\SofortOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\APM\TrustlyOrderBuilder';
$classes[] = 'Swag\PayPal\Checkout\Payment\PayPalPaymentHandler';
$classes[] = 'Swag\PayPal\Checkout\Payment\Handler\EcsSpbHandler';
$classes[] = 'Swag\PayPal\OrdersApi\Patch\PurchaseUnitPatchBuilder';
$classes[] = 'Swag\PayPal\Checkout\Payment\Handler\PayPalHandler';
$classes[] = 'Swag\PayPal\Checkout\Payment\PayPalPuiPaymentHandler';
$classes[] = 'Swag\PayPal\Checkout\Payment\ScheduledTask\CancelTransactionsTask';
$classes[] = 'Swag\PayPal\Checkout\Payment\ScheduledTask\CancelTransactionsTaskHandler';
$classes[] = 'Swag\PayPal\Checkout\Payment\Service\OrderExecuteService';
$classes[] = 'Swag\PayPal\Checkout\Payment\Service\OrderPatchService';
$classes[] = 'Swag\PayPal\OrdersApi\Patch\CustomIdPatchBuilder';
$classes[] = 'Swag\PayPal\Checkout\Payment\Service\TransactionDataService';
$classes[] = 'Swag\PayPal\Checkout\Plus\PlusPaymentFinalizeController';
$classes[] = 'Swag\PayPal\Checkout\Plus\PlusSubscriber';
$classes[] = 'Swag\PayPal\Checkout\Plus\Service\PlusDataService';
$classes[] = 'Swag\PayPal\PaymentsApi\Builder\CartPaymentBuilder';
$classes[] = 'Swag\PayPal\Checkout\SalesChannel\CreateOrderRoute';
$classes[] = 'Swag\PayPal\Checkout\SalesChannel\ErrorRoute';
$classes[] = 'Swag\PayPal\Checkout\SalesChannel\FilteredPaymentMethodRoute';
$classes[] = 'Shopware\Core\Checkout\Payment\SalesChannel\PaymentMethodRoute';
$classes[] = 'Swag\PayPal\Checkout\SalesChannel\MethodEligibilityRoute';
$classes[] = 'Swag\PayPal\Dispute\Administration\DisputeController';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\DisputeResource';
$classes[] = 'Swag\PayPal\Installment\Banner\InstallmentBannerSubscriber';
$classes[] = 'Swag\PayPal\Installment\Banner\Service\BannerDataService';
$classes[] = 'Swag\PayPal\OpenApi\OpenApiPathsSubscriber';
$classes[] = 'Swag\PayPal\OrdersApi\Administration\PayPalOrdersController';
$classes[] = 'Swag\PayPal\RestApi\V2\Resource\AuthorizationResource';
$classes[] = 'Swag\PayPal\RestApi\V2\Resource\CaptureResource';
$classes[] = 'Swag\PayPal\RestApi\V2\Resource\RefundResource';
$classes[] = 'Swag\PayPal\OrdersApi\Administration\Service\CaptureRefundCreator';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\OrderFromCartBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\OrderFromOrderBuilder';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\Util\AddressProvider';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\Util\ItemListProvider';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\Util\PurchaseUnitProvider';
$classes[] = 'Swag\PayPal\OrdersApi\Builder\Util\AmountProvider';
$classes[] = 'Swag\PayPal\OrdersApi\Patch\OrderNumberPatchBuilder';
$classes[] = 'Swag\PayPal\PaymentsApi\Administration\PayPalPaymentController';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\SaleResource';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\AuthorizationResource';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\OrdersResource';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\CaptureResource';
$classes[] = 'Swag\PayPal\Util\PaymentStatusUtil';
$classes[] = 'Swag\PayPal\PaymentsApi\Builder\OrderPaymentBuilder';
$classes[] = 'Swag\PayPal\Pos\Api\Service\ApiKeyDecoder';
$classes[] = 'Swag\PayPal\Pos\Api\Service\Converter\UuidConverter';
$classes[] = 'Swag\PayPal\Pos\Client\PosClientFactory';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Entity\PosSalesChannelDefinition';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Entity\PosSalesChannelInventoryDefinition';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Entity\PosSalesChannelMediaDefinition';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Entity\PosSalesChannelProductDefinition';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Entity\PosSalesChannelRunDefinition';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Entity\PosSalesChannelRunLogDefinition';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Extension\ProductExtension';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Extension\ProductStreamExtension';
$classes[] = 'Swag\PayPal\Pos\DataAbstractionLayer\Extension\SalesChannelExtension';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\CloneVisibilityHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\InventoryUpdateHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\SyncManagerHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Manager\ImageSyncManager';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Manager\ProductSyncManager';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\Sync\ImageSyncHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\Sync\InventorySyncHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\Sync\ProductCleanupSyncHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\Sync\ProductSingleSyncHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Handler\Sync\ProductVariantSyncHandler';
$classes[] = 'Swag\PayPal\Pos\MessageQueue\Manager\InventorySyncManager';
$classes[] = 'Swag\PayPal\Pos\PosSyncController';
$classes[] = 'Swag\PayPal\Pos\Run\Administration\SyncResetter';
$classes[] = 'Swag\PayPal\Pos\Resource\InventoryResource';
$classes[] = 'Swag\PayPal\Pos\Resource\ProductResource';
$classes[] = 'Swag\PayPal\Pos\Resource\TokenResource';
$classes[] = 'Swag\PayPal\Pos\Client\TokenClientFactory';
$classes[] = 'Swag\PayPal\Pos\Run\Administration\LogCleaner';
$classes[] = 'Monolog\Logger';
$classes[] = 'Swag\PayPal\Pos\Run\LoggerFactory';
$classes[] = 'Swag\PayPal\Pos\Run\RunService';
$classes[] = 'Swag\PayPal\Pos\Run\Task\CompleteTask';
$classes[] = 'Swag\PayPal\Pos\Run\Task\ImageTask';
$classes[] = 'Swag\PayPal\Pos\Run\Task\InventoryTask';
$classes[] = 'Swag\PayPal\Pos\Run\Task\ProductTask';
$classes[] = 'Swag\PayPal\Pos\Schedule\CleanUpLogTask';
$classes[] = 'Swag\PayPal\Pos\Schedule\CleanUpLogTaskHandler';
$classes[] = 'Swag\PayPal\Pos\Schedule\CompleteSyncTask';
$classes[] = 'Swag\PayPal\Pos\Schedule\CompleteSyncTaskHandler';
$classes[] = 'Swag\PayPal\Pos\Schedule\InventorySyncTask';
$classes[] = 'Swag\PayPal\Pos\Schedule\InventorySyncTaskHandler';
$classes[] = 'Swag\PayPal\Pos\Setting\Service\InformationDefaultService';
$classes[] = 'Swag\PayPal\Pos\Setting\SettingsController';
$classes[] = 'Swag\PayPal\Pos\Setting\Service\ApiCredentialService';
$classes[] = 'Swag\PayPal\Pos\Setting\Service\InformationFetchService';
$classes[] = 'Swag\PayPal\Pos\Resource\UserResource';
$classes[] = 'Swag\PayPal\Pos\Setting\Service\ProductVisibilityCloneService';
$classes[] = 'Swag\PayPal\Pos\Setting\Service\ProductCountService';
$classes[] = 'Swag\PayPal\Pos\Sync\Context\InventoryContextFactory';
$classes[] = 'Swag\PayPal\Pos\Sync\ImageSyncer';
$classes[] = 'Swag\PayPal\Pos\Api\Service\MediaConverter';
$classes[] = 'Swag\PayPal\Pos\Resource\ImageResource';
$classes[] = 'Swag\PayPal\Pos\Sync\InventorySyncer';
$classes[] = 'Swag\PayPal\Pos\Sync\Inventory\LocalUpdater';
$classes[] = 'Swag\PayPal\Pos\Sync\Inventory\Calculator\LocalCalculator';
$classes[] = 'Swag\PayPal\Pos\Sync\Inventory\RemoteUpdater';
$classes[] = 'Swag\PayPal\Pos\Sync\Inventory\Calculator\RemoteCalculator';
$classes[] = 'Swag\PayPal\Pos\Sync\Inventory\StockSubscriber';
$classes[] = 'Swag\PayPal\Pos\Sync\ProductSelection';
$classes[] = 'Swag\PayPal\Pos\Sync\ProductSyncer';
$classes[] = 'Swag\PayPal\Pos\Api\Service\ProductConverter';
$classes[] = 'Swag\PayPal\Pos\Api\Service\Converter\CategoryConverter';
$classes[] = 'Swag\PayPal\Pos\Api\Service\Converter\VariantConverter';
$classes[] = 'Swag\PayPal\Pos\Api\Service\Converter\PriceConverter';
$classes[] = 'Swag\PayPal\Pos\Api\Service\Converter\PresentationConverter';
$classes[] = 'Swag\PayPal\Pos\Api\Service\Converter\OptionGroupConverter';
$classes[] = 'Swag\PayPal\Pos\Api\Service\MetadataGenerator';
$classes[] = 'Swag\PayPal\Pos\Sync\Context\ProductContextFactory';
$classes[] = 'Swag\PayPal\Pos\Sync\Product\NewUpdater';
$classes[] = 'Swag\PayPal\Pos\Sync\Product\OutdatedUpdater';
$classes[] = 'Swag\PayPal\Pos\Sync\Product\DeletedUpdater';
$classes[] = 'Swag\PayPal\Pos\Sync\Product\UnsyncedChecker';
$classes[] = 'Swag\PayPal\Pos\Webhook\Handler\InventoryChangedHandler';
$classes[] = 'Swag\PayPal\Pos\Sync\Inventory\Calculator\LocalWebhookCalculator';
$classes[] = 'Swag\PayPal\Pos\Webhook\WebhookController';
$classes[] = 'Swag\PayPal\Pos\Webhook\WebhookService';
$classes[] = 'Swag\PayPal\Pos\Resource\SubscriptionResource';
$classes[] = 'Swag\PayPal\Pos\Webhook\WebhookRegistry';
$classes[] = 'Swag\PayPal\RestApi\Client\PayPalClientFactory';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\TokenResource';
$classes[] = 'Swag\PayPal\RestApi\Client\TokenClientFactory';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\IdentityResource';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\PaymentResource';
$classes[] = 'Swag\PayPal\RestApi\V1\Service\TokenValidator';
$classes[] = 'Swag\PayPal\RestApi\V2\Resource\OrderResource';
$classes[] = 'Swag\PayPal\Setting\Service\CredentialsUtil';
$classes[] = 'Swag\PayPal\Setting\Service\SettingsValidationService';
$classes[] = 'Swag\PayPal\Setting\SettingsController';
$classes[] = 'Swag\PayPal\Setting\Service\ApiCredentialService';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\CredentialsResource';
$classes[] = 'Swag\PayPal\RestApi\Client\CredentialsClientFactory';
$classes[] = 'Swag\PayPal\Setting\Service\MerchantIntegrationsService';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\MerchantIntegrationsResource';
$classes[] = 'Swag\PayPal\Storefront\Data\CheckoutDataSubscriber';
$classes[] = 'Swag\PayPal\Storefront\Data\FundingSubscriber';
$classes[] = 'Swag\PayPal\Storefront\Data\Service\FundingEligibilityDataService';
$classes[] = 'Swag\PayPal\Storefront\Data\Service\ACDCCheckoutDataService';
$classes[] = 'Swag\PayPal\Storefront\Data\Service\SEPACheckoutDataService';
$classes[] = 'Swag\PayPal\Storefront\Data\Service\SPBCheckoutDataService';
$classes[] = 'Swag\PayPal\Storefront\RequestSubscriber';
$classes[] = 'Swag\PayPal\Util\Lifecycle\ActivateDeactivate';
$classes[] = 'Swag\PayPal\Util\Lifecycle\State\PosStateService';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Installer\MediaInstaller';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Installer\PaymentMethodInstaller';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\ACDCMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\BancontactMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\BlikMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\EpsMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\GiropayMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\IdealMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\MultibancoMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\MyBankMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\OxxoMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\P24MethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\PUIMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\PayPalMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\PaymentMethodDataRegistry';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\SEPAMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\SofortMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\Method\TrustlyMethodData';
$classes[] = 'Swag\PayPal\Util\Lifecycle\State\PaymentMethodStateService';
$classes[] = 'Swag\PayPal\Util\LocaleCodeProvider';
$classes[] = 'Swag\PayPal\Util\Log\LoggerFactory';
$classes[] = 'Swag\PayPal\Util\PaymentMethodUtil';
$classes[] = 'Swag\PayPal\Util\PaymentStatusUtilV2';
$classes[] = 'Swag\PayPal\Util\PriceFormatter';
$classes[] = 'Swag\PayPal\Webhook\Handler\AuthorizationVoided';
$classes[] = 'Swag\PayPal\Webhook\Handler\CaptureCompleted';
$classes[] = 'Swag\PayPal\Webhook\Handler\CaptureDenied';
$classes[] = 'Swag\PayPal\Webhook\Handler\CaptureRefunded';
$classes[] = 'Swag\PayPal\Webhook\Handler\CaptureReversed';
$classes[] = 'Swag\PayPal\Webhook\Handler\SaleComplete';
$classes[] = 'Swag\PayPal\Webhook\Handler\SaleDenied';
$classes[] = 'Swag\PayPal\Webhook\Handler\SaleRefunded';
$classes[] = 'Swag\PayPal\Webhook\Registration\WebhookSubscriber';
$classes[] = 'Swag\PayPal\Webhook\Registration\WebhookSystemConfigController';
$classes[] = 'Swag\PayPal\Webhook\Registration\WebhookSystemConfigHelper';
$classes[] = 'Swag\PayPal\Webhook\WebhookController';
$classes[] = 'Swag\PayPal\Webhook\WebhookService';
$classes[] = 'Swag\PayPal\RestApi\V1\Resource\WebhookResource';
$classes[] = 'Swag\PayPal\Webhook\WebhookRegistry';
...
$classes[] = 'Sas\BlogModule\Content\Blog\DataResolver\BlogDetailCmsElementResolver';
