...
class __TwigTemplate_c99e37fbd27e64325e46a9b15eb5b27af6831be6c704388b4df1c6a206aa633a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_header_actions_account_widget_dropdown_button($context, array $blocks = [])
    {
        ...
        echo "=\"dropdown\"
                    ...
                    aria-label=\"";
        // line 11
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.myAccount")), "html", null, true);
        echo "\"
                    title=\"";
        // line 12
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.myAccount")), "html", null, true);
    ...
    {
        return new Source("", "@Storefront/storefront/layout/header/actions/account-widget.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/header/actions/account-widget.html.twig");
    }
}
