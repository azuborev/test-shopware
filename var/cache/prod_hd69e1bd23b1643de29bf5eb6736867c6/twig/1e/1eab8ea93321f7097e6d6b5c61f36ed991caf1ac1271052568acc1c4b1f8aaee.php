...
class __TwigTemplate_e953f069254133343231273ed9e3889678ae2733c2158c89bceec18f59b6769b extends Template
{
    private $source;
    private $macros = [];
...
($context["taxItem"] ?? null), "taxRate", [], "any", false, false, false, 7)]));
    ...
    public function block_page_checkout_summary_tax_value($context, array $blocks = [])
    {
        ...
        echo "                <dd class=\"col-5 checkout-aside-summary-value summary-tax\">
                    ";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Shopware\Core\Framework\Adapter\Twig\Filter\CurrencyFilter']->formatCurrency($context, sw_get_attribute($this->env, $this->source, ($context["taxItem"] ?? null), "tax", [], "any", false, false, false, 14)), "html", null, true);
        echo "
                </dd>
            ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/page/checkout/summary/summary-tax.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/page/checkout/summary/summary-tax.html.twig");
    }
}
