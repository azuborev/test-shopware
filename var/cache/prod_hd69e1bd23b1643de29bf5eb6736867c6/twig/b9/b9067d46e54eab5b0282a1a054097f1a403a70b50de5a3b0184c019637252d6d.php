...
class __TwigTemplate_89d77e7d10ac06756b3a1c7ad4fcff26f261ad67eba93447fbdd5e33fa601f94 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_navigation_offcanvas_navigation_category_headline_text($context, array $blocks = [])
    {
        ...
        echo "            <span itemprop=\"name\">
                ";
        // line 8
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["item"] ?? null), "translated", [], "any", false, false, false, 8), "name", [], "any", false, false, false, 8), "html", null, true);
        echo "
            </span>
        ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/layout/navigation/offcanvas/active-item-link.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/navigation/offcanvas/active-item-link.html.twig");
    }
}
