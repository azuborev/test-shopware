...
class __TwigTemplate_c7a3fc414e853288ebf262d4244c273109ba3a3c8d5ad01bdf3ca270fec56e47 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_page_account_sidebar_header($context, array $blocks = [])
    {
        ...
        if ( !($context["headerWidget"] ?? null)) {
            ...
            echo "
                        ";
            // line 8
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["context"] ?? null), "customer", [], "any", false, false, false, 8), "title", [], "any", false, false, false, 8), "html", null, true);
            echo "
                        ";
            // line 9
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["context"] ?? null), "customer", [], "any", false, false, false, 9), "firstName", [], "any", false, false, false, 9), "html", null, true);
            echo "
                        ";
            // line 10
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["context"] ?? null), "customer", [], "any", false, false, false, 10), "lastName", [], "any", false, false, false, 10), "html", null, true);
            echo "
                    </div>
                ";
        }
    ...
    public function block_page_account_sidebar_link_home($context, array $blocks = [])
    {
        ...
        echo "\"
                                   title=\"";
        // line 21
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.overviewLink")), "html", null, true);
        echo "\"
    ...
    public function block_page_account_sidebar_link_profile($context, array $blocks = [])
    {
        ...
        echo "\"
                                   title=\"";
        // line 29
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.profileLink")), "html", null, true);
        echo "\"
                                   class=\"list-group-item list-group-item-action account-aside-item";
        // line 30
    ...
    public function block_page_account_sidebar_link_address($context, array $blocks = [])
    {
        ...
        echo "\"
                                   title=\"";
        // line 37
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.addressLink")), "html", null, true);
        echo "\"
                                   class=\"list-group-item list-group-item-action account-aside-item";
        // line 38
    ...
    public function block_page_account_sidebar_link_payment($context, array $blocks = [])
    {
        ...
        echo "\"
                                   title=\"";
        // line 45
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.paymentLink")), "html", null, true);
        echo "\"
                                   class=\"list-group-item list-group-item-action account-aside-item";
        // line 46
    ...
    public function block_page_account_sidebar_link_orders($context, array $blocks = [])
    {
        ...
        echo "\"
                                   title=\"";
        // line 53
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.ordersLink")), "html", null, true);
        echo "\"
                                   class=\"list-group-item list-group-item-action account-aside-item";
        // line 54
    ...
    {
        return new Source("", "@Storefront/storefront/page/account/sidebar.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/page/account/sidebar.html.twig");
    }
}
