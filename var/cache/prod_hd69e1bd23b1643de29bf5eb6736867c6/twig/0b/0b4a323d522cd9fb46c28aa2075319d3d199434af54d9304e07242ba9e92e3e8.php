...
class __TwigTemplate_a7a999c4c7956c10b67f1a3a10b5e1bd3e280e798423d6129467f899626fdcc1 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_layout_navigation_offcanvas_navigation_home_link($context, array $blocks = [])
    {
       ...
       title=\"";
        // line 5
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("general.mainMenu")), "html", null, true);
        echo "\">
        ";
        // line 6
...
";
    ...
    {
        return new Source("", "@Storefront/storefront/layout/navigation/offcanvas/show-all-link.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/navigation/offcanvas/show-all-link.html.twig");
    }
}
