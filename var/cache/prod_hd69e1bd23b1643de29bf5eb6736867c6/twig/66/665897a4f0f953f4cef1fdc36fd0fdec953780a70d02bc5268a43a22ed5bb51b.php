...
class __TwigTemplate_c8e366ff89c86960536bd31b030ae07c03e7241eea2e45325c50859198b2dc2f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_component_filter_range($context, array $blocks = [])
    {
        ...
        // line 64
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["filterRangeOptions"] ?? null)]), "html", null, true);
        echo "'>
...
";
    ...
    public function block_component_filter_range_toggle($context, array $blocks = [])
    {
        ...
        if (($context["sidebar"] ?? null)) {
            ...
            echo "=\"dropdown\"
                    ...
                    ";
            // line 76
            echo twig_escape_filter($this->env, ($context["dataBsOffsetAttr"] ?? null), "html", null, true);
            echo "=\"0,8\"
                    aria-haspopup=\"true\"
                    ";
        }
    ...
    public function block_component_filter_range_min_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                           min=\"";
        // line 108
        echo twig_escape_filter($this->env, ($context["minInputValue"] ?? null), "html", null, true);
        echo "\"
                                           max=\"";
        // line 109
        echo twig_escape_filter($this->env, ($context["maxInputValue"] ?? null), "html", null, true);
        echo "\">
                                ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/component/listing/filter/filter-range.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/listing/filter/filter-range.html.twig");
    }
}
