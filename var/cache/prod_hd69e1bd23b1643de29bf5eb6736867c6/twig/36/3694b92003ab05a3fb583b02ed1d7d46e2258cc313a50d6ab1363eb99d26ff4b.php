...
class __TwigTemplate_081311c97e4888993856c9171db765b83eaeb4e6da38afd8ecb8269a9caf9bc1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_header_logo_link($context, array $blocks = [])
    {
        ...
        echo "\"
               title=\"";
        // line 6
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("header.logoLink")), "html", null, true);
        echo "\">
                ";
        // line 7
    ...
    {
        return new Source("", "@Storefront/storefront/layout/header/logo.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/header/logo.html.twig");
    }
}
