...
class __TwigTemplate_4671cec9de52e002e3f24bb50c6a855155f9f4c1ed25374303b4f12471dea08f extends Template
{
    private $source;
    private $macros = [];
...
($context["waitTime"] ?? null)]))]));
    ...
    public function block_component_account_login_form_mail_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                               ...
                                               placeholder=\"";
        // line 75
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.loginMailPlaceholder")), "html", null, true);
        echo "\"
                                               name=\"username\"
                                               required=\"required\">
                                    ";
    ...
    public function block_component_account_login_form_password_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                               ...
                                               placeholder=\"";
        // line 94
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.loginPasswordPlaceholder")), "html", null, true);
        echo "\"
                                               name=\"password\"
                                               required=\"required\">
                                    ";
    ...
    {
        return new Source("", "@Storefront/storefront/component/account/login.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/account/login.html.twig");
    }
}
