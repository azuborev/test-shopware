...
class __TwigTemplate_139aefba04337b9feec6f55c2e781e6cc24cf77da4dea10b0b9a28bbf7a72afb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_navigation_offcanvas_navigation_categories_list_category_item_link($context, array $blocks = [])
    {
        ...
        if (($context["hasChildren"] ?? null)) {
            // line 11
            echo "                data-href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("frontend.menu.offcanvas", ["navigationId" => sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["item"] ?? null), "category", [], "any", false, false, false, 11), "id", [], "any", false, false, false, 11)]), "html", null, true);
            echo "\"
            ";
        }
        // line 13
    ...
    {
        return new Source("", "@Storefront/storefront/layout/navigation/offcanvas/item-link.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/navigation/offcanvas/item-link.html.twig");
    }
}
