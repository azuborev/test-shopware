...
class __TwigTemplate_04a70ed361a7e1059e1564334c6815611a0a4df9109106e10ae4af2e88c5d39b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_component_filter_multi_select($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["pluginSelector"] ?? null), "html", null, true);
        echo "-options='";
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["dataPluginSelectorOptions"] ?? null)]), "html", null, true);
        echo "'>
...
";
    ...
    {
        return new Source("", "@Storefront/storefront/component/listing/filter/filter-multi-select.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/listing/filter/filter-multi-select.html.twig");
    }
}
