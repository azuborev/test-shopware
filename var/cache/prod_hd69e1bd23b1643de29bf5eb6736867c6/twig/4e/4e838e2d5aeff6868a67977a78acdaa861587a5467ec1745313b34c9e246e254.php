...
class __TwigTemplate_1b94f52c7e26214417a14f4ab346e1de063b823bd8dd501521dd5ce9b6ad249f extends Template
{
    private $source;
    private $macros = [];
...
($context["sidebar"] ?? null), "name" => "rating", "pluginSelector" => "filter-rating-select", "displayName" => $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("listing.filterRatingDisplayName"))]));
    ...
    {
        return new Source("", "@Storefront/storefront/component/listing/filter-panel.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/listing/filter-panel.html.twig");
    }
}
