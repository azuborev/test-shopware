...
class __TwigTemplate_4e3d5bd71785c38237134b5957b61f724c27b065cd39b2a7d44a4317ce7737c0 extends Template
{
    private $source;
    private $macros = [];
...
($context["product"] ?? null), "ratingAverage", [], "any", false, false, false, 76), "style" => "text-primary"]));
    ...
    public function block_component_product_box_variant_characteristics($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["variation"]) {
            // line 96
            echo "                                            ";
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, $context["variation"], "group", [], "any", false, false, false, 96), "html", null, true);
            echo ":
                                            <span class=\"product-variant-characteristics-option\">
                                                ";
            // line 98
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, $context["variation"], "option", [], "any", false, false, false, 98), "html", null, true);
            echo "
                                            </span>
    ...
    public function block_component_product_box_action($context, array $blocks = [])
    {
        ...
        // line 120
        echo "                                ";
        $this->loadTemplate("@SwagPayPal/storefront/component/product/card/action.html.twig", "@Storefront/storefront/component/product/card/box-standard.html.twig", 120)->display($context);
        // line 121
        echo "                            ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/component/product/card/box-standard.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/product/card/box-standard.html.twig");
    }
}
