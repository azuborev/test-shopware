...
class __TwigTemplate_001ce654cc973d6507b41d360a9b435f50c27215ab28cf36c35af21845291123 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_page_checkout_summary_total_value($context, array $blocks = [])
    {
        ...
        if ((0 === twig_compare(sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["page"] ?? null), "cart", [], "any", false, false, false, 10), "price", [], "any", false, false, false, 10), "taxStatus", [], "any", false, false, false, 10), "gross"))) {
            echo twig_escape_filter($this->env, twig_trim_filter($this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("general.star"))), "html", null, true);
        }
        // line 11
        echo "        </dd>
    ";
    ...
    {
        return new Source("", "@Storefront/storefront/page/checkout/summary/summary-total.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/page/checkout/summary/summary-total.html.twig");
    }
}
