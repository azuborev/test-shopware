...
class __TwigTemplate_839daef2ca0eacd22ab1c2fa82c5517a901a8f49ea15dba8721dfbdf1e8f7a39 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_base_html($context, array $blocks = [])
    {
        ...
        // line 9
        echo "<html lang=\"";
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 9), "locale", [], "any", false, false, false, 9), "html", null, true);
        echo "\"
      itemscope=\"itemscope\"
...
($context["page"] ?? null), "product", [], "any", false, false, false, 76), "seoCategory", [], "any", false, false, false, 76)]));
    ...
    public function block_base_footer_inner($context, array $blocks = [])
    {
        ...
        // line 91
        echo "                    ";
        $this->loadTemplate("@SwagPayPal/storefront/layout/footer/footer.html.twig", "@Storefront/storefront/base.html.twig", 91)->display($context);
        // line 92
        echo "                ";
    }
    ...
    public function block_base_script_router($context, array $blocks = [])
    {
        ...
        // line 120
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, false, 120), "navigation", [], "any", false, false, false, 120), "active", [], "any", false, false, false, 120), "id", [], "any", false, false, false, 120), "html", null, true);
        echo "';
                    window.router = {
        ...
        // line 135
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 135), "attributes", [], "any", false, false, false, 135), "get", [0 => "sw-sales-channel-id"], "method", false, false, false, 135), "html", null, true);
        echo "';
                </script>
            ";
    }
    ...
    public function block_base_script_csrf($context, array $blocks = [])
    {
        ...
        echo "                <script>
                    window.csrf = {
                        'enabled': '";
        // line 166
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["shopware"] ?? null), "csrfEnabled", [], "any", false, false, false, 166), "html", null, true);
        echo "',
                        'mode': '";
        // line 167
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["shopware"] ?? null), "csrfMode", [], "any", false, false, false, 167), "html", null, true);
        echo "'
                    }
                </script>
            ";
    ...
    {
        return new Source("", "@Storefront/storefront/base.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/base.html.twig");
    }
}
