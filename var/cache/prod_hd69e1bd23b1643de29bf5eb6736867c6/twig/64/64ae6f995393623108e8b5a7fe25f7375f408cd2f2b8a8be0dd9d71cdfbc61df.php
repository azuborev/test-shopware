...
class __TwigTemplate_03480801956d0d27aa13449826a4caabe608ee01ce5e6e320dd963a4743c2760 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 8
        echo "    ";
        if (($this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\FeatureFlagExtension']->feature("V6_5_0_0") && ($context["paginationLocation"] ?? null))) {
            // line 9
            echo "        ";
    ...
    public function block_component_pagination_first_input($context, array $blocks = [])
    {
        ...
        echo "                                   name=\"p\"
                                   id=\"p-first";
        // line 22
        echo twig_escape_filter($this->env, ($context["paginationSuffix"] ?? null), "html", null, true);
        echo "\"
                                   value=\"1\"
                                   class=\"d-none\"
                                   title=\"pagination\">
    ...
    {
        return new Source("", "@Storefront/storefront/component/pagination.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/pagination.html.twig");
    }
}
