...
class __TwigTemplate_e09f5fa0b4104a09d6c752c615ec8284e37326ea458a2f166039a76fe7783797 extends Template
{
    private $source;
    private $macros = [];
...
($context["data"] ?? null), "get", [0 => "billingAddress"], "method", false, false, false, 64)]));
    ...
    public function block_component_account_register_personal_mail_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                                   ...
                                                   placeholder=\"";
        // line 82
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.personalMailPlaceholder")), "html", null, true);
        echo "\"
                                                   name=\"email\"
                                                   value=\"";
        // line 84
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["data"] ?? null), "get", [0 => "email"], "method", false, false, false, 84), "html", null, true);
        echo "\"
                                                   ";
        // line 85
    ...
    public function block_component_account_register_personal_mail_confirmation_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                                   ...
                                                   placeholder=\"";
        // line 115
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.personalMailConfirmationPlaceholder")), "html", null, true);
        echo "\"
                                                   name=\"emailConfirmation\"
                                                   value=\"";
        // line 117
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["data"] ?? null), "get", [0 => "emailConfirmation"], "method", false, false, false, 117), "html", null, true);
        echo "\"
                                                   data-form-validation-equal=\"personalMail\"
                                                   data-form-validation-equal-message=\"";
        // line 119
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.personalMailConfirmationInvalidMessage")), "html", null, true);
        echo "\"
                                                   required=\"required\">
                                        ";
    }
    ...
    public function block_component_account_register_personal_password_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                                       ...
                                                       placeholder=\"";
        // line 154
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.personalPasswordPlaceholder")), "html", null, true);
        echo "\"
                                                       name=\"password\"
                                                       minlength=\"";
        // line 156
        echo twig_escape_filter($this->env, $this->extensions['Shopware\Storefront\Framework\Twig\Extension\ConfigExtension']->config($context, "core.loginRegistration.passwordMinLength"), "html", null, true);
        echo "\"
                                                       ";
        // line 157
    ...
    public function block_component_account_register_personal_password_confirmation_input($context, array $blocks = [])
    {
        ...
        echo "\"
                                                       ...
                                                       placeholder=\"";
        // line 206
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.personalPasswordConfirmationPlaceholder")), "html", null, true);
        echo "\"
        ...
        echo "\"
                                                       ...
                                                       data-form-validation-equal-message=\"";
        // line 210
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("account.personalPasswordConfirmationInvalidMessage")), "html", null, true);
        echo "\"
                                                       required=\"required\">
                                            ";
    }
...
($context["data"] ?? null), "get", [0 => "shippingAddress"], "method", false, false, false, 336), "showNoShippingPostfix" => true, "disableNonShippableCountries" => true]));
    ...
    {
        return new Source("", "@Storefront/storefront/component/account/register.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/account/register.html.twig");
    }
}
