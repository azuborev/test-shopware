...
class __TwigTemplate_7603de53a1fa2eadea1026ded535a039c26ee8a6f0615ecf659c4e4bcdb12782 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_header_minimal_button($context, array $blocks = [])
    {
        ...
        echo "\"
                                   ...
                                   title=\"";
        // line 25
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("checkout.finishButtonBackToShop")), "html", null, true);
        echo "\">
                                    ";
        // line 26
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("checkout.finishButtonBackToShop")), "html", null, true);
    ...
    {
        return new Source("", "@Storefront/storefront/layout/header/header-minimal.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/header/header-minimal.html.twig");
    }
}
