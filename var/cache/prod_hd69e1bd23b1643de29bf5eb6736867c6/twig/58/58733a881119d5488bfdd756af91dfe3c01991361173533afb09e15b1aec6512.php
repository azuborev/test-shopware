...
class __TwigTemplate_e99a01ad4e96053d578194c34e1162c3eb0fac702b91b96bfb3dfc08bbcd6734 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_component_hidden_line_items_information($context, array $blocks = [])
    {
        ...
        echo "    <div class=\"d-none hidden-line-items-information\"
         data-currency=\"";
        // line 3
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["context"] ?? null), "currency", [], "any", false, false, false, 3), "translated", [], "any", false, false, false, 3), "shortName", [], "any", false, false, false, 3), "html", null, true);
        echo "\"
         data-shipping=\"";
        // line 4
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["cart"] ?? null), "deliveries", [], "any", false, false, false, 4), "shippingCosts", [], "any", false, false, false, 4), "sum", [], "method", false, false, false, 4), "totalPrice", [], "any", false, false, false, 4), "html", null, true);
        echo "\"
         data-value=\"";
        // line 5
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["cart"] ?? null), "price", [], "any", false, false, false, 5), "totalPrice", [], "any", false, false, false, 5), "html", null, true);
        echo "\"
         data-tax=\"";
        // line 6
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["cart"] ?? null), "price", [], "any", false, false, false, 6), "calculatedTaxes", [], "any", false, false, false, 6), "amount", [], "any", false, false, false, 6), "html", null, true);
        echo "\"
    >
        ";
        // line 8
...
";
    ...
    public function block_component_hidden_line_item_information($context, array $blocks = [])
    {
        ...
        echo "                <span class=\"hidden-line-item\"
                      data-id=\"";
        // line 16
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["lineItem"] ?? null), "id", [], "any", false, false, false, 16), "html", null, true);
        echo "\"
                      data-name=\"";
        // line 17
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["lineItem"] ?? null), "label", [], "any", false, false, false, 17), "html", null, true);
        echo "\"
                      data-quantity=\"";
        // line 18
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["lineItem"] ?? null), "quantity", [], "any", false, false, false, 18), "html", null, true);
        echo "\"
                      data-price=\"";
        // line 19
    ...
    {
        return new Source("", "@Storefront/storefront/component/checkout/hidden-line-items-information.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/checkout/hidden-line-items-information.html.twig");
    }
}
