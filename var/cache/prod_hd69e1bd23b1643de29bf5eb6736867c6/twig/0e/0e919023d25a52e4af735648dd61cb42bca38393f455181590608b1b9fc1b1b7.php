...
class __TwigTemplate_f39a376e569a881773d3d493f24522adc3ee3db48097f8b1088b67c86b3c77f2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"modal fade\"
        ...
        echo "
                    <button type=\"button\"
                            class=\"";
        // line 17
        echo twig_escape_filter($this->env, ($context["modalCloseBtnClass"] ?? null), "html", null, true);
        echo " close\"
                            ";
        // line 18
        echo twig_escape_filter($this->env, ($context["dataBsDismissAttr"] ?? null), "html", null, true);
        echo "=\"modal\"
                            aria-label=\"Close\">
                        ";
        // line 20
...
";
    ...
    {
        return new Source("", "@Storefront/storefront/component/pseudo-modal.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/pseudo-modal.html.twig");
    }
}
