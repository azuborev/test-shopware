...
class __TwigTemplate_7fb2b92314ec4f272eed652ae216dc8c0c560dd907ee2fc342ffd8e569378627 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_header_search($context, array $blocks = [])
    {
        ...
        // line 12
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["searchWidgetOptions"] ?? null)]), "html", null, true);
        echo "'
                  data-url=\"";
        // line 13
...
";
    ...
    public function block_layout_header_search_input($context, array $blocks = [])
    {
        ...
        echo "                            <input type=\"search\"
                                   ...
                                   placeholder=\"";
        // line 23
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("header.searchPlaceholder")), "html", null, true);
        echo "\"
                                   aria-label=\"";
        // line 24
        echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("header.searchPlaceholder")), "html", null, true);
        echo "\"
                                   value=\"";
        // line 25
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["page"] ?? null), "searchTerm", [], "any", false, false, false, 25), "html", null, true);
        echo "\"
                            >
                        ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/layout/header/search.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/layout/header/search.html.twig");
    }
}
