...
class __TwigTemplate_b068290b132d2be58428b13de407e7a5f74251fc45beb3c8f4d16bc2ddd31653 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_component_product_box_rich_snippets_brand($context, array $blocks = [])
    {
        ...
        // line 6
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["product"] ?? null), "manufacturer", [], "any", false, false, false, 6), "translated", [], "any", false, false, false, 6), "name", [], "any", false, false, false, 6), "html", null, true);
        echo "\" />
        </div>
    ";
    }
    ...
    public function block_component_product_box_rich_snippets_mpn($context, array $blocks = [])
    {
        ...
        if (sw_get_attribute($this->env, $this->source, ($context["product"] ?? null), "manufacturerNumber", [], "any", false, false, false, 19)) {
            ...
            echo "            <meta itemprop=\"mpn\"
                  content=\"";
            // line 21
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["product"] ?? null), "manufacturerNumber", [], "any", false, false, false, 21), "html", null, true);
            echo "\"/>
        ";
        }
        // line 23
    ...
    {
        return new Source("", "@Storefront/storefront/component/product/card/meta.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/product/card/meta.html.twig");
    }
}
