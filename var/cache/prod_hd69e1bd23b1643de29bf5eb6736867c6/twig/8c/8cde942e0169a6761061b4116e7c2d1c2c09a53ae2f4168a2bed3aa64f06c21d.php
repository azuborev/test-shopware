...
class __TwigTemplate_2f7a8d87ded3f59945894d73bb8184d43be9c70acecd2da488c6651d428beea6 extends Template
{
    private $source;
    private $macros = [];
...
($context["displayName"] ?? null), "snippets" => ["disabledFilterText" => $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("listing.disabledFilterTooltip"))]];
    ...
    public function block_component_filter_boolean_panel_item($context, array $blocks = [])
    {
        ...
        // line 13
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["filterBooleanOptions"] ?? null)]), "html", null, true);
        echo "'>
    ...
    {
        return new Source("", "@Storefront/storefront/component/listing/filter/filter-boolean.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/listing/filter/filter-boolean.html.twig");
    }
}
