...
class __TwigTemplate_cee5b843fcb7b95b2adede2bc8d3de5c29355f550ea74ad7e1a631ee778e318d extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((($context["showSorting"] ?? null) && (1 === twig_compare(twig_length_filter($this->env, ($context["sortings"] ?? null)), 1)))) {
            ...
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["config"] ?? null)]), "html", null, true);
            echo "'>
        <select class=\"sorting ";
            // line 6
            echo twig_escape_filter($this->env, ($context["formSelectClass"] ?? null), "html", null, true);
            echo "\" aria-label=\"";
            echo twig_escape_filter($this->env, twig_striptags($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("general.sortingLabel")), "html", null, true);
            echo "\">
            ";
            // line 7
...
";
    ...
    {
        return new Source("", "@Storefront/storefront/component/sorting.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/sorting.html.twig");
    }
}
