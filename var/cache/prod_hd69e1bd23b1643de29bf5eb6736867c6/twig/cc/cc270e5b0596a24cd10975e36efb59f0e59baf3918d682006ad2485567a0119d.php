...
class __TwigTemplate_56653fdd5a341f2c73b459b13ddaf0e786cdcbc824ef91a3401287ec3d65573a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_block_image_text_left($context, array $blocks = [])
    {
        ...
        // line 9
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "id", [], "any", false, false, false, 9), "html", null, true);
        echo "\">
            ";
        // line 10
    ...
    public function block_block_image_text_right($context, array $blocks = [])
    {
        ...
        <div class=\"col-md-6\" data-cms-element-id=\"";
        // line 19
        echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "id", [], "any", false, false, false, 19), "html", null, true);
        echo "\">
            ";
        // line 20
    ...
    {
        return new Source("", "@Storefront/storefront/block/cms-block-image-text.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/block/cms-block-image-text.html.twig");
    }
}
