...
class __TwigTemplate_e56698cc806e2c212445c67304ea050dbe0135187b45ef1e6e3594da73648200 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_product_listing($context, array $blocks = [])
    {
        ...
        // line 24
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["listingPagination"] ?? null)]), "html", null, true);
        echo "'>
...
($context["searchResult"] ?? null), "criteria", [], "any", false, false, false, 86), "paginationLocation" => "bottom"]));
    ...
    {
        return new Source("", "@Storefront/storefront/component/product/listing.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/product/listing.html.twig");
    }
}
