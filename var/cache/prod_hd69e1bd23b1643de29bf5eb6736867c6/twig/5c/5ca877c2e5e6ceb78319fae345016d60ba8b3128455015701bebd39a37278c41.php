...
class __TwigTemplate_c1be35dbdaab203a192ad13eef51ccccdffb2618a8ecc7dc8b0ead7c64ce67a3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_component_offcanvas_summary_content_info($context, array $blocks = [])
    {
        ...
        if (sw_get_attribute($this->env, $this->source, ($context["loop"] ?? null), "first", [], "any", false, false, false, 25)) {
            ...
            echo ">
                                        (";
            // line 27
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["activeShipping"] ?? null), "shippingMethod", [], "any", false, false, false, 27), "translated", [], "any", false, false, false, 27), "name", [], "any", false, false, false, 27), "html", null, true);
            echo ")
                                    </small>
                                ";
        }
    ...
    public function block_component_offcanvas_summary_content_shipping_select($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["shippingMethod"]) {
            ...
            echo "                                        <option
                                            value=\"";
            // line 62
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, $context["shippingMethod"], "id", [], "any", false, false, false, 62), "html", null, true);
            echo "\"
                                            ";
            // line 63
            ...
            echo " >
                                            ";
            // line 64
            echo twig_escape_filter($this->env, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, $context["shippingMethod"], "translated", [], "any", false, false, false, 64), "name", [], "any", false, false, false, 64), "html", null, true);
            echo "
                                        </option>
                                    ";
        }
    ...
    {
        return new Source("", "@Storefront/storefront/component/checkout/offcanvas-cart-summary.html.twig", "/var/www/shopwareloc/vendor/shopware/storefront/Resources/views/storefront/component/checkout/offcanvas-cart-summary.html.twig");
    }
}
